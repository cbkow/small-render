...
- Supporting slow file syncing services for the file system. ie. LucidLink, Dropbox, Synology Drive, and Resilio--allowing usage without even a NAS in the middle. However, SMB/LAN will work just as well.
